            ...
            <table class="frmtbl">
               ...
               <tr>
                     ...
                     <td><select id="col" name="col">
                        ...
                        <option>St. Xavier's College, Kolkata</option>
                        <option>National Institute of Technology (NIT) Durgapur</option>
                        <option>Maulana Abul Kalam Azad University of Technology (MAKAUT)</option>
                        <option>Ramakrishna Mission Residential College, Narendrapur</option>
                        <option>Bidhannagar College</option>
