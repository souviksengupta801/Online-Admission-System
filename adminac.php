...
<html>
    ...
    <body>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%;"><img src="./images/ROYS LOGO.png" width="50%"> </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:20px;">
                    ROY'S INSTITUTION, BHATPARA - 743126, WEST BENGAL</font></center>
                
                <center><font style="font-family:Verdana; font-size:18px;">
                    Phone : (+91)6291029247, Email : aswanikumarnayak223@gmail.com
                    </font></center>
                
                <br>
                <br>
                <center><font style="font-family:Arial Black; font-size:20px;">
                   ADMIT CARD</font></center>
                </td>
                    ...
                    while($row1 = mysqli_fetch_array($result1))
                      {                  
                        ...
                        echo "<img src='$picsrc.' class='img-thumbnail' style='width:100%;'>";
                        echo"<div>";
                      }
                   ?>
                        </td>
                 ...
                 <td style="width:4%;"> <font style="font-family: Verdana;">Date</font> </td>
                    <td style="width:8%;" colspan="3"><font style="font-family: Verdana; font-weight: bold">
                        1st Jan 2025, Afternoon Session</font> </td>
                 </tr>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td style="width:8%;" colspan="3">
                       <font style="font-family: Verdana; font-weight: bold"> ROY'S INSTITUTION<br>
                        At - BHATPARA<br>
                        P.O - BHATPARA<br>
                        Dist: 24PG(N) - 743126<br>
