...
if(isset($_REQUEST["in_sub"]))
{
    ...
    $sql  = "insert into t_user_data(s_id, s_pwd, s_dob, s_name, s_email, s_mob, s_signupdate) values(";
    $sql .= "'" . $stid . "',";
    $sql .= "'" . $stpw . "',";
    $sql .= "'" . $dob . "',";
    $sql .= "'" . $name . "',";
...
//     header('location:signupconfirm.php');
  ...
  function StudentCode()
  {
    ...
    while (!$isUnique) {
        ...
        $randomId = $prefix . str_pad($randomNumber, 5, "0", STR_PAD_LEFT);

        // Check if the ID exists in the database
        $query = "SELECT COUNT(*) AS count FROM t_user_data WHERE s_id = '$randomId'";
